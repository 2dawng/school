...
public class SinhVienKT extends SinhVien {
    ...
    public SinhVienKT(String maSV, String hoTen, String ngaySinh, String gioiTinh, String chuyenNganh,
            MonHoc[] monHoc) {
    ...
    public void nhap() {
        ...
        monHocs.add(new MonHoc("Kinh Te Vi Mo", 0.0));
        monHocs.add(new MonHoc("Kinh Te Vix Mo", 0.0));
        monHocs.add(new MonHoc("Luat Kinh Te", 0.0));
